# As-Is Workflow Builder — 설치판

AX Lens 맵 빌더의 로컬 실행 버전입니다. **최신 설치판 다운로드:**

👉 https://github.com/HyungyungChoiPWC/hr-workflow-ai-dist/releases/latest/download/hr-workflow-ai.zip

(이 저장소의 Code → Download ZIP 도 같은 내용입니다. 버전: v2026.09.07-910b112, 웹 버전: https://pwc-ax-lens.com/map)
